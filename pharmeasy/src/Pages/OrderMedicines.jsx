  ...
  return (
    <Box width="80%" margin="auto">
            ...
            <Flex>
              <Flex alignItems="center" paddingRight="30px">
                <Image
                  w="15px"
                  h="15px"
                  src="https://pharmeasy.in/_next/image?url=%2Ficons%2FvaluePropDisc.svg&w=16&q=75"
                />
                <Text
                  fontSize="12px"
                  fontWeight="400"
              ...
              <Flex alignItems="center" paddingRight="30px">
                <Image
                  w="15px"
                  h="15px"
                  src="https://pharmeasy.in/_next/image?url=%2Ficons%2FvaluePropProd.svg&w=16&q=75"
                />
                <Text
                  fontSize="12px"
                  fontWeight="400"
        ...
        <Box>
          ...
          >
            <Image
              ...
              w="32px"
              h="32px"
              src="https://static1.squarespace.com/static/570d83a355598634587821aa/t/57337f63c2ea51ad0fa05508/1462992752843/icon_prioritize.png"
              alt=""
            />
            <Heading fontSize="16px" fontWeight="600" color="#4f585e">
              {" "}
          ...
          >
            <Flex>
              <Image
                ...
                w="40px"
                h="22px"
                src="https://th.bing.com/th/id/OIP.Ti4BbWThlntt0eHnkEXEQAHaEc?w=274&h=180&c=7&r=0&o=5&pid=1.7"
                alt=""
              />
              <Heading fontSize="16px" fontWeight="600" color="#4f585e">
                {" "}
            ...
            <Flex
              ...
              borderRadius="6px"
            >
              <button bg="teal">Or call on +91 99929 99929</button>
              <Spacer />
      ...
      <Text color="#8897a2" marginBottom="5px">
        The concept of medicine home delivery has been taken to a new level by
        the PharmEasy online medicine delivery app. You can use the PharmEasy
        online medicine delivery app to browse through an extensive range of
        medicines. Each medicine undergoes a 3-step quality check.
      </Text>
      <Text color="#8897a2" marginBottom="5px">
        Whatever be your medicinal requirement, you are sure to locate it in
        this online pharmacy. All you have to do then is to add it to your cart
        and place the order. In 3 hours*, the medicines will be delivered to
        you. India’s beloved online medicine delivery app makes sure that you
        get your medicines in record time because we know how vital time is in
        any treatment. Sit back, and we will have all your medical necessities
      ...
      <br />
      <Text color="#8897a2" marginBottom="5px">
        Tired of walking all the way to your local medicine store? Worried that
        going out is risky during the current times? Order medicines online at
        PharmEasy, India’s trusted online medicine app. With more than 1 lakh
        medicines always in stock, you are sure to find what you are looking
        for, and that too at affordable prices!
      </Text>
      <Text color="#8897a2" marginBottom="5px">
        Besides, extremely stringent sanitization norms are followed at your
        favourite online medical store. PharmEasy takes the safety of customers
      ...
      <br />
      <Text color="#8897a2" marginBottom="5px">
        Here are a few reasons that will convince you to give online medicine
        order through the PharmEasy app -
      </Text>
      ...
      <br />
      <Text color="#8897a2" marginBottom="5px">
        PharmEasy is a one-stop-shop for all your healthcare needs. We have 1L+
        products for you to choose from. Buy medicines online at affordable
        prices from the comforts of your home in just a few clicks and get them
      ...
      <Text color="#8897a2" marginBottom="5px">
        With our scheduled refill reminder, you don’t even need to keep track of
        your refill dates. What’s more, we have great offers, with added
        discounts and massive e-wallet cashbacks on purchasing medicines!
      </Text>
    </Box>
  );
};
