    ...
    <div>
      ...
      <Flex>
        <Box
          ...
          p="4"
          w="100%"
          onClick={() => navigate('/orderMedicines')}
        >
        ...
        <Box
          p="4"
          w="100%"
          onClick={() => navigate('/healthcareProducts')}
        >
      ...
      <Box w="100%">
        <Img
          minW="100%"
          src="https://i.imgur.com/JJecxvy.png
"
        />
      </Box>
      <br />
      ...
      {loading ? (
        ...
        <SliderSmall key={Math.random() * 1000} data={data} />
      )}
      ...
      <Box bg="#d4e2fa">
        {labTest.loading ? (
          ...
          <LabtestSlider key={Math.random() * 1000} data={labTest.data} />
        )}
      </Box>
      <br />
      <Box>
      ...
      <Box>
        <ProductSlider key={Math.random() * 1000} />
      </Box>
      <br />
      <br />
      ...
      <Box bg="#d4e2fa" h="auto">
        {labTest.loading ? (
          ...
          <MedocomeSlider key={Math.random() * 1000} data={allProduct.data} />
        )}
      </Box>
      <br />
      <br />
